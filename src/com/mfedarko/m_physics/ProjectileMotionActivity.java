...
public class ProjectileMotionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_projectile_motion);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_projectile_motion, menu);
        return true;
    }
    ...
    public void goToPMProblemScreen(View view) {
		Intent i = new Intent(getApplicationContext(), ProjectileMotionProblemActivity.class);
		startActivity(i);
	}

    public void goToCannonScreen(View view) {
		Intent i = new Intent(getApplicationContext(), CannonActivity.class);
		startActivity(i);
	}    
}
